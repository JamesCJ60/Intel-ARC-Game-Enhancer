...
namespace AATUV3.Scripts.SMU_Backend_Scripts
{
    internal class RwMmioAmd
    {
        ...
        uint RdFchMisc(uint regadd, uint startbit, uint endbit)
        {
            ...
            uint pdwPhysVal = 0;
            Flow_Control.MainWindow.GetPhysLong(p, ref pdwPhysVal);
        ...
        void WrFchMisc(uint regadd, uint Value, uint startbit, uint endbit)
        {
            ...
            Flow_Control.MainWindow.SetPhysLong(p, pdwPhysVal);
            //Cg1CfgUpdateReq();
        }
        ...
        public void SetBclk2(double BCLK)
        {
            // disable ssc
            uint pdwPhysVal = 0;
            Flow_Control.MainWindow.GetPhysLong((UIntPtr)0xFED80E08, ref pdwPhysVal); // cpu.io.GetPhysLong((UIntPtr)0xFED80E08, out uint value);
            pdwPhysVal = setbit2(pdwPhysVal, 0, 0, 0);
            Flow_Control.MainWindow.SetPhysLong((UIntPtr)0xFED80E08, pdwPhysVal); // cpu.io.SetPhysLong((UIntPtr)0xFED80E08, ZenStates.Core.Utils.SetBits(value, 0, 0, 0));

            // CG1_FBDIV_LoadEn
            Flow_Control.MainWindow.GetPhysLong((UIntPtr)0xFED80E40, ref pdwPhysVal); // cpu.io.GetPhysLong((UIntPtr)0xFED80E40, out value);
            pdwPhysVal = setbit2(pdwPhysVal, 1, 25, 25);
            Flow_Control.MainWindow.SetPhysLong((UIntPtr)0xFED80E40, pdwPhysVal); // cpu.io.SetPhysLong((UIntPtr)0xFED80E40, ZenStates.Core.Utils.SetBits(value, 25, 1, 1));

            // Set bclk
            Flow_Control.MainWindow.GetPhysLong((UIntPtr)0xFED80E10, ref pdwPhysVal); //cpu.io.GetPhysLong((UIntPtr)0xFED80E10, out value);
            ...
            Flow_Control.MainWindow.SetPhysLong((UIntPtr)0xFED80E10, pdwPhysVal); // cpu.io.SetPhysLong((UIntPtr)0xFED80E10, value);

            Flow_Control.MainWindow.GetPhysLong((UIntPtr)0xFED80E40, ref pdwPhysVal); //cpu.io.GetPhysLong((UIntPtr)0xFED80E40, out value);
            pdwPhysVal = setbit2(pdwPhysVal, 1, 30, 30);
            Flow_Control.MainWindow.SetPhysLong((UIntPtr)0xFED80E40, pdwPhysVal); //cpu.io.SetPhysLong((UIntPtr)0xFED80E40, ZenStates.Core.Utils.SetBits(value, 30, 1, 1));
        }
